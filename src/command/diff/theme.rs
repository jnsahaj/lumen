...
impl FromStr for ThemePreset {
    ...
    fn from_str(s: &str) -> Result<Self, Self::Err> {
        match s.to_lowercase().replace('_', "-").as_str() {
            ...
            "rose-pine" => Ok(Self::RosePine),
            "rose-pine-moon" => Ok(Self::RosePineMoon),
            "rose-pine-dawn" => Ok(Self::RosePineDawn),
            _ => Err(format!(
                "Unknown theme '{}'. Valid: default-dark, default-light, catppuccin-mocha, catppuccin-latte, dracula, nord, gruvbox-dark, gruvbox-light, one-dark, solarized-dark, solarized-light, flexoki-dark, flexoki-light, rose-pine, rose-pine-moon, rose-pine-dawn",
                s
            )),
        }
    }
...
impl Theme {
    ...
    pub fn from_preset(preset: ThemePreset) -> Self {
        match preset {
            ...
            ThemePreset::RosePineMoon => Self::rose_pine_moon(),
            ThemePreset::RosePineDawn => Self::rose_pine_dawn(),
        }
    }
    ...
    pub fn rose_pine() -> Self {
        Self {
            ...
            syntax: SyntaxColors {
                ...
                function_macro: Color::Rgb(235, 188, 186),
                r#type: Color::Rgb(156, 207, 216),
                variable_builtin: Color::Rgb(235, 111, 146),
                variable_member: Color::Rgb(224, 222, 244),
                module: Color::Rgb(156, 207, 216),
                operator: Color::Rgb(144, 140, 170),
                tag: Color::Rgb(156, 207, 216),
                attribute: Color::Rgb(196, 167, 231),
                label: Color::Rgb(196, 167, 231),
                punctuation: Color::Rgb(144, 140, 170),
                default_text: Color::Rgb(224, 222, 244),
            },
            // Blend additions and deletions into the base: 10% lines, 20% gutters, 25% words.
            diff: DiffColors {
                added_bg: Color::Rgb(38, 41, 54),
                added_gutter_bg: Color::Rgb(51, 60, 72),
                added_gutter_fg: Color::Rgb(156, 207, 216),
                deleted_bg: Color::Rgb(46, 32, 47),
                deleted_gutter_bg: Color::Rgb(67, 41, 58),
                deleted_gutter_fg: Color::Rgb(235, 111, 146),
                context_bg: Color::Rgb(25, 23, 36),
                empty_placeholder_fg: Color::Rgb(64, 61, 82),
                added_word_bg: Color::Rgb(58, 69, 81),
                deleted_word_bg: Color::Rgb(78, 45, 64),
            },
            ui: UiColors {
                ...
                footer_branch_bg: Color::Rgb(38, 35, 58),
                footer_branch_fg: Color::Rgb(196, 167, 231),
                status_added: Color::Rgb(156, 207, 216),
                status_modified: Color::Rgb(246, 193, 119),
                status_deleted: Color::Rgb(235, 111, 146),
                stats_added: Color::Rgb(156, 207, 216),
                stats_removed: Color::Rgb(235, 111, 146),
                selection_bg: Color::Rgb(64, 61, 82),
                selection_fg: Color::Rgb(224, 222, 244),
                highlight: Color::Rgb(196, 167, 231),
                viewed: Color::Rgb(156, 207, 216),
                watching: Color::Rgb(246, 193, 119),
                search_match_bg: Color::Rgb(82, 79, 103),
                search_match_fg: Color::Rgb(224, 222, 244),
                search_current_bg: Color::Rgb(246, 193, 119),
    ...
    pub fn rose_pine_moon() -> Self {
        Self {
            ...
            syntax: SyntaxColors {
                comment: Color::Rgb(110, 106, 134),
                keyword: Color::Rgb(62, 143, 176),
                string: Color::Rgb(246, 193, 119),
                number: Color::Rgb(246, 193, 119),
                function: Color::Rgb(234, 154, 151),
                function_macro: Color::Rgb(234, 154, 151),
                r#type: Color::Rgb(156, 207, 216),
                variable_builtin: Color::Rgb(235, 111, 146),
                variable_member: Color::Rgb(224, 222, 244),
                module: Color::Rgb(156, 207, 216),
            ...
            // Blend additions and deletions into the base: 10% lines, 20% gutters, 25% words.
            diff: DiffColors {
                added_bg: Color::Rgb(47, 50, 70),
                added_gutter_bg: Color::Rgb(59, 68, 86),
                added_gutter_fg: Color::Rgb(156, 207, 216),
                deleted_bg: Color::Rgb(55, 41, 63),
                deleted_gutter_bg: Color::Rgb(75, 49, 72),
                deleted_gutter_fg: Color::Rgb(235, 111, 146),
                context_bg: Color::Rgb(35, 33, 54),
                empty_placeholder_fg: Color::Rgb(68, 65, 90),
                added_word_bg: Color::Rgb(65, 76, 94),
                deleted_word_bg: Color::Rgb(85, 52, 77),
            },
            ui: UiColors {
                border_focused: Color::Rgb(196, 167, 231),
                border_unfocused: Color::Rgb(68, 65, 90),
                text_primary: Color::Rgb(224, 222, 244),
                text_secondary: Color::Rgb(144, 140, 170),
                text_muted: Color::Rgb(110, 106, 134),
                line_number: Color::Rgb(110, 106, 134),
                bg: Color::Rgb(35, 33, 54),
                footer_branch_bg: Color::Rgb(57, 53, 82),
                footer_branch_fg: Color::Rgb(196, 167, 231),
                status_added: Color::Rgb(156, 207, 216),
                status_modified: Color::Rgb(246, 193, 119),
                status_deleted: Color::Rgb(235, 111, 146),
                ...
                viewed: Color::Rgb(156, 207, 216),
                watching: Color::Rgb(246, 193, 119),
                search_match_bg: Color::Rgb(86, 82, 110),
                search_match_fg: Color::Rgb(224, 222, 244),
                search_current_bg: Color::Rgb(246, 193, 119),
                search_current_fg: Color::Rgb(35, 33, 54),
            },
        }
    }
    ...
    pub fn rose_pine_dawn() -> Self {
        Self {
            ...
            syntax: SyntaxColors {
                ...
                number: Color::Rgb(234, 157, 52),
                function: Color::Rgb(215, 130, 126),
                function_macro: Color::Rgb(215, 130, 126),
                r#type: Color::Rgb(86, 148, 159),
                variable_builtin: Color::Rgb(180, 99, 122),
                variable_member: Color::Rgb(70, 66, 97),
                module: Color::Rgb(86, 148, 159),
                operator: Color::Rgb(121, 117, 147),
                tag: Color::Rgb(86, 148, 159),
                attribute: Color::Rgb(144, 122, 169),
                label: Color::Rgb(144, 122, 169),
                punctuation: Color::Rgb(121, 117, 147),
                default_text: Color::Rgb(70, 66, 97),
            },
            // Blend additions and deletions into the base: 10% lines, 20% gutters, 25% words.
            diff: DiffColors {
                added_bg: Color::Rgb(229, 230, 226),
                added_gutter_bg: Color::Rgb(208, 216, 216),
                added_gutter_fg: Color::Rgb(40, 105, 131),
                deleted_bg: Color::Rgb(243, 230, 226),
                deleted_gutter_bg: Color::Rgb(236, 215, 214),
                deleted_gutter_fg: Color::Rgb(180, 99, 122),
                context_bg: Color::Rgb(250, 244, 237),
                empty_placeholder_fg: Color::Rgb(223, 218, 217),
                added_word_bg: Color::Rgb(198, 209, 210),
                deleted_word_bg: Color::Rgb(232, 208, 208),
            },
            ui: UiColors {
                border_focused: Color::Rgb(144, 122, 169),
                border_unfocused: Color::Rgb(223, 218, 217),
                text_primary: Color::Rgb(70, 66, 97),
                text_secondary: Color::Rgb(121, 117, 147),
                text_muted: Color::Rgb(152, 147, 165),
                line_number: Color::Rgb(152, 147, 165),
                bg: Color::Rgb(250, 244, 237),
                footer_branch_bg: Color::Rgb(242, 233, 225),
                footer_branch_fg: Color::Rgb(144, 122, 169),
                status_added: Color::Rgb(40, 105, 131),
                status_modified: Color::Rgb(234, 157, 52),
                status_deleted: Color::Rgb(180, 99, 122),
                stats_added: Color::Rgb(40, 105, 131),
                stats_removed: Color::Rgb(180, 99, 122),
                selection_bg: Color::Rgb(223, 218, 217),
                selection_fg: Color::Rgb(70, 66, 97),
                highlight: Color::Rgb(144, 122, 169),
                viewed: Color::Rgb(40, 105, 131),
                watching: Color::Rgb(234, 157, 52),
                search_match_bg: Color::Rgb(206, 202, 205),
                search_match_fg: Color::Rgb(70, 66, 97),
                search_current_bg: Color::Rgb(234, 157, 52),
                search_current_fg: Color::Rgb(70, 66, 97),
            },
        }
    }
}
